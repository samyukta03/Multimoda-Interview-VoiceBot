# -*- coding: utf-8 -*-
"""
Created on Wed Mar 22 22:35:34 2023
...
def run_code():
    xx = pd.read_excel('D:/Prediction-of-Job-Interview-Performance-by-extracting-Lexical-features-/Top_seven_features.xlsx',sheet_name = 'NoFillers')
    ...
    ws = wb['Coeff']
    ws.cell(row=5,column=1,value='NoFillers')
    ws.cell(row=5,column=2,value=correlation[0,1])
    wb.save('coeff.xlsx')
    ...
    ws=wb['Final']
    ws.cell(row=2,column=5,value=(y_pred[0]*10))

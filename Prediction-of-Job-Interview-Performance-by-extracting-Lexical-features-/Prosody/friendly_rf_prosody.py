# -*- coding: utf-8 -*-
"""
Created on Thu Apr 27 16:01:56 2023
...
def run_code():
   ...
   # correlation = np.corrcoef(val, y_ts.squeeze())
   # print("Correlation coefficient l+p :", correlation[0, 1])
run_code()

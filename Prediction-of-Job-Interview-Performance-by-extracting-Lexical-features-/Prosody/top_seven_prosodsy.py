# -*- coding: utf-8 -*-
"""
Created on Thu Apr 27 12:43:32 2023
...
ws = openpyxl.load_workbook('Coeff_of_Determination.xlsx')
sheet = ws['Coefficient of determination']

ws1 = openpyxl.load_workbook('prosodic_features1.xlsx')
sheet1 = ws1['prosodic_features']

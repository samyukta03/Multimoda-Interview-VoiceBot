...
def run_code():
    xx = pd.read_excel('D:/Prediction-of-Job-Interview-Performance-by-extracting-Lexical-features-/Top_seven_features.xlsx',sheet_name = 'SpeakingRate')
    ...
    ws = wb['Coeff']
    ws.cell(row=8,column=1,value='Speaking rate')
    ws.cell(row=8,column=2,value=correlation[0,1])
    wb.save('coeff.xlsx')
